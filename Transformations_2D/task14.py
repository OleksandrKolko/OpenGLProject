...
pivot_transformed = transform_point(pivot, T)

print("Трансформовані вершини:")
for p in transformed_points:
    print(f"({p[0]:.3f}, {p[1]:.3f})")
print(f"Pivot (1,1) після трансформації: ({pivot_transformed[0]:.3f}, {pivot_transformed[1]:.3f})")
...
scene = Task14Scene(
    ...
    title="Task 14: Matrix Decomposition with Pivot (1,1)",
    axis_show=True,
    grid_show=True,
